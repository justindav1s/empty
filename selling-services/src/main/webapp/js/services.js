...
sellingAppServices.factory('PersonResource', ['$resource', function($resource) {
   return $resource('http://myapp-test2.ba.datr.eu/selling/s/person/:verb;pid=:pid',
   null,
{
		'create': {method:'POST', params:{verb:'create'}, url:'http://myapp-test2.ba.datr.eu/selling/s/person/:verb'},
		...
		'list': {method:'GET', params:{verb:'list'}, isArray:true, url:'http://myapp-test2.ba.datr.eu/selling/s/person/:verb'}
       });
}]);
