...
public class PersonCreateNoLastNameConsumerPactTest {
    ...
    @Rule
    public PactProviderRule provider = new PactProviderRule("person_provider", "localhost", 8082, this);
    ...
    public PactFragment createFragment(PactDslWithProvider builder) {
        ...
        return builder
                ...
                .uponReceiving("a save person request with no last name")
                .path("/person/create")
                .method("POST")
                .headers(headers)
                .body(buildBadPersonNoLastName().toJson())
                .willRespondWith()
                .status(400)
                .headers(headers)
                .body(buildReservationErrorResponse("invalid person message - no last name").toJson())
                .toFragment();
    }
    ...
    public void runTest3() throws IOException {
        ...
        //Bad Person 2
        assertEquals(new ConsumerClient("http://localhost:8082").postForStatusCode("/person/create", buildBadPersonNoLastName().toJson(), header, ContentType.APPLICATION_JSON), 400);
