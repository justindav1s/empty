CREATE USER justin SUPERUSER LOGIN PASSWORD 'justin';
CREATE DATABASE selling with OWNER justin;
GRANT ALL PRIVILEGES ON TABLE bookings TO justin
\connect selling
...
GRANT ALL PRIVILEGES ON SEQUENCE BA_SEQ TO justin;
GRANT ALL PRIVILEGES ON TABLE persons TO justin;
GRANT ALL PRIVILEGES ON TABLE bookings TO justin;
GRANT ALL PRIVILEGES ON TABLE flights TO justin;
GRANT ALL PRIVILEGES ON TABLE loyalty TO justin;
